...
GUIDE: dict[str, list[tuple[str, str]]] = {
    ...
    "fr": [
        ...
        ("Écrire le programme",
         ...
         "par ligne ; un livre entier ne demande aucun numéro de chapitre.<br>"
    ...
    "he": [
        ...
        ("כתיבת חומר הבחינה",
         ...
         "המקובלים. ספר אחד בכל שורה; ספר שלם אינו דורש מספרי פרקים כלל.<br>"
    ...
    "es": [
        ("En una frase",
         "Usted escribe el temario que está estudiando; la aplicación le indica "
         "qué palabras y expresiones aparecen en él una sola vez, y le entrega "
         "un PDF para estudiar o repartir."),
        ("Tres pasos",
         "<ul>"
         "<li><b>1.</b> Escriba o pegue el temario en el cuadro grande de "
         "arriba a la izquierda — o elija un libro y capítulos y pulse "
         "<b>Añadir</b>.</li>"
        ...
        ("Escribir el temario",
         ...
         "un libro entero no necesita ningún número de capítulo.<br>"
         "Debajo del cuadro se muestra <b>cuántos capítulos, versículos y "
         "palabras</b> se han reconocido. Si una línea es ilegible o no se "
         "reconoce el nombre de un libro, aparece un aviso justo debajo "
         "indicando la línea en cuestión: nada se descarta sin decírselo."),
        ("¿Único dentro de qué?",
         "El ajuste más importante. Una palabra puede ser única en un pasaje y "
         "corriente en otro:"
         "<ul>"
         "<li><b>Todo el Tanaj</b> — el verdadero hápax, una vez entre las "
         "305.531 palabras.</li>"
         "<li><b>El temario</b> — una vez en el temario que ha escrito.</li>"
         "<li><b>Su propio libro</b> — único dentro de un libro. Es decir, la "
         "palabra puede aparecer varias veces en el temario, pero si es única "
         "en uno de los libros se mostrará. Esto permite responder a preguntas "
         "del tipo: «¿Dónde aparece esta palabra en tal libro?».</li>"
         "<li><b>Una sección</b> — único dentro de una sección del Tanaj: Torá, "
         "Nevi'im, Nevi'im Rishonim, Nevi'im Acharonim, Trei Asar, "
         "Ketuvim…</li>"
         "<li><b>Un rango que usted escribe</b> — único dentro de ese rango, "
         "escrito como el temario, por ejemplo <code>ישעיהו א-לט</code>.</li>"
         "</ul>"),
        ("…¿todo el libro o solo mi parte?",
         "La casilla bajo el menú «Único dentro de» decide si se cuentan los "
         "capítulos que no ha listado en el temario.<br>"
         "Ejemplo: temario <code>ישעיהו א-לט</code>. <b>Sin marcar</b>, la "
         "palabra debe aparecer una vez en los 66 capítulos — una que reaparece "
         "en el capítulo 50 se rechaza aunque no la esté estudiando. "
         "<b>Marcada</b>, solo cuentan los capítulos 1-39 y esa palabra sí se "
         "muestra.<br>"
        ...
        ("Expresiones, no solo palabras",
         ...
         "también lo es cualquier expresión que la contenga. La opción "
         "conserva solo las expresiones únicas cuyas partes más cortas "
         "<i>no</i> lo son.<br>"
         "<b>Cada palabra aparece ≥ N</b> conserva solo las expresiones cuyas "
         "palabras son <i>todas</i> frecuentes: con 50, cada palabra de la "
         "expresión aparece al menos 50 veces en el Tanaj. Lo sorprendente es "
         "entonces la expresión y no el vocabulario — a menudo las mejores "
         "preguntas."),
        ("Comparar por",
         "Qué cuenta como «la misma palabra»:"
         "<ul>"
         "<li><b>Forma escrita</b> (predeterminado) — solo letras, sin "
         "vocales.</li>"
         "<li><b>Con vocales</b> — más estricto.</li>"
         "<li><b>Raíz</b> — todas las formas de una misma raíz cuentan como una "
         "sola palabra. Busca por tanto <i>raíces</i> únicas y no formas: mucho "
         "más raro y mucho más difícil.</li>"
         "</ul>"),
        ("Exportar",
         "Puede exportar los resultados de su búsqueda como PDF. El PDF se abre "
         "con una página inicial que recuerda sus ajustes y los totales por "
         "libro, y después los resultados agrupados por capítulo en columnas. "
         "Opcional: el <b>versículo completo</b> bajo cada entrada con la "
         "palabra en negrita, un <b>índice alfabético</b> y una <b>hoja de "
         "práctica</b> con soluciones aparte.<br>"
         "También hay <b>HTML</b> y <b>CSV</b>; el CSV se abre en Excel y sirve "
         "para otros usos, por ejemplo si quiere reutilizar los resultados en "
         "otro proyecto de programación."),
        ("Numeración de versículos",
         ...
         "para seguir la mayoría de los programas. Solo cambia las "
         "referencias, nunca los resultados."),
        ("La pestaña de raíces",
         "No confundir con el ajuste «Comparar por → Raíz», que concierne a la "
         "búsqueda misma. Esta pestaña es un diccionario: escribe una palabra y "
         "le muestra dónde aparece esa raíz, sin volver a lanzar la búsqueda. "
         "Práctico para comprobar una intuición sobre una palabra concreta."),
        ("De dónde viene el texto",
         "El Códice de Leningrado (WLC), vía Open Scriptures Hebrew Bible — 39 "
         "libros, 23.213 versículos, 305.531 palabras, con vocales y "
         "cantilación. El texto está incluido en la aplicación; no se descarga "
         "nada y nada de lo que escriba sale de su ordenador.<br>"
         "Software libre bajo licencia GPL; el texto del Tanaj sigue bajo su "
         "licencia CC-BY. Los PDF que produzca le pertenecen."),
    ],
    ...
    "pt": [
        ...
        ("Escrever o programa",
         ...
         "linha; um livro inteiro não precisa de qualquer número de "
         "capítulo.<br>"
    ...
    "ru": [
        ...
        ("Как записать материал",
         ...
         "строке; для целой книги номера глав не нужны вовсе.<br>"
