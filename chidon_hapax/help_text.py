...
GUIDE: dict[str, list[tuple[str, str]]] = {
    ...
    "es": [
        ...
        ("Escribir el temario",
         ...
         "un libro entero no necesita ningún número de capítulo. Los nombres de los libros pueden escribirse en hebreo, inglés, francés, español, portugués o ruso, con o sin acentos.<br>"
